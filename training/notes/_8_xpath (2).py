...
# time.sleep(2)
#
# driver.find_element('xpath', '//input[@name="search_query"]').send_keys('spider man')
# time.sleep(2)
# driver.find_element('xpath', '(//button[@title="Search"])[1]').click()
# time.sleep(2)
# driver.find_element('xpath', '(//a[@id="video-title"])[2]').click()
...
####################################################################################################
'''
3. wap to click on the release notes of python 3.9.22
'''
# from selenium import webdriver
#
...
####################################################################################################
'''
4.  Go to https://www.iforex.in/tools/live-rates, wap to fetch the sell price and gold price of gold
'''
...
# print('sell price of gold = ', gold_sellprice.text)
#
# gold_buyprice = driver.find_element('xpath', '(//div[text()="Gold"]/../..//span)[3]')
# print("buy price of gold = ", gold_buyprice.text)
